...
const ConsoleModal: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    const handleModel = (memory: string): void => {
      setCurrentStep((prev) => prev + 1);
        ...
        return (
          <div className="w-full h-[500px]">
            ...
            >
              ...
              <option value="disabled">XIos</option>
            </select>
          </div>
        );
...
//             </h2>
//             <p className="text-[#6B6B6B] text-base leading-6 mt-4">
//               Please select your console to add the product to the cart.
//             </p>
//             <select
//               className="w-full px-3 py-2 my-3 text-gray-700 bg-white border border-gray-300 rounded-3xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
//               onChange={(e) => handleSelectionChange("console", e.target.value)}
//             >
...
//               className="w-full px-3 py-2 my-3 text-gray-700 bg-white border border-gray-300 rounded-3xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
//               onChange={(e) =>
//                 handleSelectionChange("location", e.target.value)
//               }
//             >
...
//             </h2>
//             <p className="text-[#6B6B6B] text-base leading-6 mt-4">
//               Please select a model for the console you chose.
//             </p>
//             <select
//               className="w-full px-3 py-2 my-3 text-gray-700 bg-white border border-gray-300 rounded-3xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
...
//             <h2 className="text-[40px] font-semibold text-[#101010]">
//               You're all set!
//             </h2>
//             <p className="text-[#6B6B6B] text-base leading-6 mt-4">
//               Thank you for your selections. You're ready to proceed.
//             </p>
//             <Button
//               type="primary"
//               className="mt-6"

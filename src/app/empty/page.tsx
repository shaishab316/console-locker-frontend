...
export default function EmptyCart() {
  return (
    <div className="min-h-[700px] flex flex-col items-center justify-center p-4 bg-gray-50">
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-3 gap-6 px-4">
        ...
        <div className="flex items-center justify-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
          ...
          <span className="text-gray-600 font-medium">12 Months Warranty</span>
        </div>
        ...
        <div className="flex items-center justify-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
          ...
          <span className="text-gray-600 font-medium">Free Return</span>
        </div>
        ...
        <div className="flex items-center justify-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
          ...
          <span className="text-gray-600 font-medium">Performs Like New</span>
        </div>
      </div>
    </div>
  );

...
export default function ScreenCondition() {
  ...
  console.log("stateOnRedux", userSelectedOptions);
  ...
  return (
    <div className="min-h-screen bg-[#F2F5F7] pb-20">
      ...
      <div className="max-w-[798px] mx-auto py-10">
        ...
        <div>{question?.data?.questions[questionIndex]?._id}</div>

        {/* <form className="space-y-4 mb-6">
          {question?.data?.questions?.map((option: IOption) => (
            <label

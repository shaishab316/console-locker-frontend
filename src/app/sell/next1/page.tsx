...
export default function ScreenCondition() {
  ...
  const getChooseQuestionFromState = useSelector(
  ...
  console.log("ready to set on store: ", selectedQuestion);

  console.log("getChooseQuestionFromState", getChooseQuestionFromState);
